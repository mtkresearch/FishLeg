...
import sys
sys.path.append('../../../FishLeg/src/optim')
...
if __name__ == "__main__":
    ...
    likelihood = FISH_LIKELIHOODS["categorical"](device=device)
    ...
    for epoch_i in range(0, epochs):
        ...
        for step, (inputs, b_labels) in enumerate(train_dataloader):
            ...
            progress_bar(step, len(train_dataloader), 'Loss: %.3f | Acc: %.3f%% (%d/%d)'
                        % (total_train_loss/(step+1), 100.*correct_samples/total_samples, correct_samples, total_samples))
